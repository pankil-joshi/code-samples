...
if(!empty($disputes)):
$counter = 1;
foreach ($disputes as $message):
    ?>        
    <div class="dispute-row <?php if ($counter % 2 == 0): ?>deactive_show<?php else: ?>active_show<?php endif; ?> cenrt_object">
        ...
        <div class="col-md-9 col-sm-12 col-xs-12 order_manage dispute-text oder_overviw">
            <div style="padding:0" class="col-md-2">
                <div class="air_max mesg_equr">
                    <h1>#D<?= $message['thread_id']; ?></h1>
                </div>
            </div>
            <div class="col-md-6 col-sm-10">
                <div class="date_detal set_detail_equr">
                    <h1>Dispute Category : ”<?= $message['type']; ?>” </h1>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="air_max mesg_equr">
                        <!--<h1>Response required by: 16/05/16</h1>-->
                    </div>
                </div>    
            </div>
...
$counter++;
    ...
    <p class="text-center"><img src="<?= $app['base_assets_url']; ?>images/no-data.png" alt="No data"> No disputes has been made yet.</p>
<?php endif; ?>